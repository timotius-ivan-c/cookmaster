...
class RecipeDetailStepsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('recipe_detail_steps')->insert([
            ...
            ['step_no' => 1, 'recipe_id' => 10, 'text' => 'Throw about 25 oreo cookies into a food processor, and chop them well.', 'image' => 'images/steps/Oreo_Truffles_1.jpg'],
            ['step_no' => 2, 'recipe_id' => 10, 'text' => 'Add a half block of softened cream cheese and process until a big clump forms in the side of the food processor. This means that the mixture is properly mixed and will hold together well.', 'image' => 'images/steps/Oreo_Truffles_2.jpg'],
            ['step_no' => 3, 'recipe_id' => 10, 'text' => 'Use a medium cookie scoop to portion out scoops of the oreo mixture.', 'image' => 'images/steps/Oreo_Truffles_3.jpg'],
            ['step_no' => 4, 'recipe_id' => 10, 'text' => 'Roll each scoop in between the palms of your hands to shape each one into a ball. Place them on a parchment paper lined sheet tray, then refrigerate the truffles for 15 minutes. This helps them firm up a little bit before dipping.', 'image' => 'images/steps/Oreo_Truffles_4.jpg'],
            ['step_no' => 5, 'recipe_id' => 10, 'text' => 'Melt some chocolate and dip the truffles. You can also add sprinkles and other topping after dipping.', 'image' => 'images/steps/Oreo_Truffles_5.jpg'],
            ['step_no' => 6, 'recipe_id' => 10, 'text' => 'Let the chocolate harden before enjoying, either at room temperature or by putting the truffles in the fridge for a quick method.', 'image' => 'images/steps/Oreo_Truffles_6.jpg'],
