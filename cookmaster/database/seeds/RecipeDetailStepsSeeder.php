...
class RecipeDetailStepsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('recipe_detail_steps')->insert([
            ...
            ['step_no' => 1, 'recipe_id' => 12, 'text' => 'Cut the chicken into bite sized pieces, about an inch big. Whisk to combine the cornstarch, soy sauce, and rice cooking wine, and add the chicken. Toss to coat, then let this sit while you make the rest of the recipe.', 'image' => 'Kung_Pao_1.jpg'],
            ['step_no' => 2, 'recipe_id' => 12, 'text' => 'For the sauce, whisk together the black vinegar, rice cooking wine, sugar, sesame oil, water, and cornstarch. Set aside.', 'image' => 'Kung_Pao_2.jpg'],
            ['step_no' => 3, 'recipe_id' => 12, 'text' => 'Heat a wok or high sided skillet over medium high heat, then add one tablespoon of grapeseed oil. Add half the marinated chicken, and let sit for 1 minute, without stirring, so the chicken can brown. Then stir the chicken and continue cooking for 2 minutes until the chicken is mostly cooked. Remove the chicken from the pan and repeat with the other half of chicken.', 'image' => 'Kung_Pao_3.jpg'],
            ['step_no' => 4, 'recipe_id' => 12, 'text' => 'After removing all the chicken, there should still be some residual oil left in the pan. If not, add another tablespoon. Add the garlic, ginger, scallions, and chiles, and stir for 30-60 seconds, until fragrant. Add the bell pepper and celery, and cook for about a minute, until slightly softened. Then add the mostly cooked chicken, the peanuts, and the sauce to the pan. Cook for 2-3 minutes, stirring the whole time, until the sauce thickens and the chicken is completely cooked through. Serve hot with rice, if desired.', 'image' => 'Kung_Pao_4.jpg'],

            ['step_no' => 1, 'recipe_id' => 13, 'text' => 'In a small bowl, toss to combine the beef, soy sauce, and rice cooking wine. Let sit while you prepare the rest of the recipe.', 'image' => 'Beef_and_Brocoli_1.jpg'],
            ['step_no' => 2, 'recipe_id' => 13, 'text' => 'For the sauce, whisk together all ingredients.', 'image' => 'Beef_and_Brocoli_2.jpg'],
            ['step_no' => 3, 'recipe_id' => 13, 'text' => 'For the stir fry, heat one tablespoon of oil in a wok or high sided skillet over high heat, and add half of the marinated beef. Let sit for 1 minute without stirring, so the beef can brown, then stir for 1-2 minutes, until the beef is mostly cooked through.', 'image' => 'Beef_and_Brocoli_3.jpg'],
            ['step_no' => 4, 'recipe_id' => 13, 'text' => 'Add the remaining tablespoon of oil to the pan and add the scallions. Stir around for 30 seconds, then add the blanched broccoli, the mostly cooked beef, and all of the sauce.Cook for 1-2 minutes until the beef is fully cooked and the sauce has thickened. Take care not to overcook the beef.', 'image' => 'Beef_and_Brocoli_4.jpg'],

            ['step_no' => 1, 'recipe_id' => 14, 'text' => 'In a large bowl, whisk to combine the soy sauce, lime juice, green curry paste, garlic, fish sauce, cumin, coriander, and honey.', 'image' => 'Chicken_Satay_1.jpg'],
            ['step_no' => 2, 'recipe_id' => 14, 'text' => 'Add the chicken to the marinade, toss to coat, then let it sit in the fridge for 2-4 hours, and up to overnight.', 'image' => 'Chicken_Satay_2.jpg'],
            ['step_no' => 3, 'recipe_id' => 14, 'text' => 'Preheat a grill** to medium high heat, and take the chicken out of the marinade (don’t discard the marinade). Grill the chicken for about 3-4 minutes on each side, until cooked through.', 'image' => 'Chicken_Satay_3.jpg'],
            ['step_no' => 4, 'recipe_id' => 14, 'text' => 'Boil for a minute or two to ensure that the bacteria is killed, then add the peanut butter and coconut milk. Bring to a simmer and cook for 3 minutes.', 'image' => 'Chicken_Satay_4.jpg'],
            ['step_no' => 5, 'recipe_id' => 14, 'text' => 'Remove from the heat, and whisk in the lime juice and honey. Taste it and adjust the seasoning with salt and pepper if necessary (and you can also add soy sauce). Serve the chicken satay and peanut sauce together.', 'image' => 'Chicken_Satay_5.jpg'],

            ['step_no' => 1, 'recipe_id' => 15, 'text' => 'To prepare the duck remove any innards and pat the bird dry. Mix the salt and the five spice powder together and generously season the duck’s cavity and exterior.', 'image' => 'Glazed_Roast_Duck_1.jpg'],
            ['step_no' => 2, 'recipe_id' => 15, 'text' => 'Combine the garlic, ginger, and orange zest. Rub the inside of the duck with the garlic mixture. Stuff the cavity with the orange slices, then truss the bird by tying the legs together with kitchen twine.', 'image' => 'Glazed_Roast_Duck_2.jpg'],
            ['step_no' => 3, 'recipe_id' => 15, 'text' => 'Roast the duck for 1 hour and 15 minutes. Meanwhile make the glaze, by whisking all four glaze ingredients until combined.', 'image' => 'Glazed_Roast_Duck_3.jpg'],
            ['step_no' => 4, 'recipe_id' => 15, 'text' => 'After the duck has cooked for 1 hour and 15 minutes, cook for an additional 35 minutes, glazing three more times throughout that time period, until the duck reaches 165 degrees on an instant read thermometer, measured at the thickest part of the leg. The duck is ready to eat, enjoy!', 'image' => 'Glazed_Roast_Duck_4.jpg'],
        ]);
    }
}
