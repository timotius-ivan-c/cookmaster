...
class TransactionsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('transactions')->insert([
            ...
            ['recipient_id' => 10, 'sender_id' => 6, 'token' => Str::random(10), 'amount' => 100000, 'date' => Carbon::create(2021, 01, 01,  15, 32, 42, 'Asia/Jakarta'), 'message' => 'Subscribe to William Poernomo. Duration 3 months.', 'transaction_type_id' => 2],
