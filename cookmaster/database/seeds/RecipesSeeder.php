...
class RecipesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('recipes')->insert([
            ...
            ['author_id' => 10, 'name' => 'Oreo Truffles', 'image' => 'recipes/Oreo_Truffles.jpg', 'review_count' => 15, 'average_rating' => 4.88, 'publish_date' => Carbon::create(2019, 8, 15,  19, 32, 11, 'Asia/Jakarta'), 'recipe_type' => 1, 'recipe_category_id' => 3],
