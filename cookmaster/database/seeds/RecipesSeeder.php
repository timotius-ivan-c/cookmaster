...
class RecipesSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('recipes')->insert([
            ...
            ['author_id' => 14, 'name' => 'Kung Pao Chicken', 'image' => 'Kung_Pao.jpg', 'review_count' => 15, 'average_rating' => 4.88, 'publish_date' => Carbon::create(2019, 8, 15,  19, 32, 11, 'Asia/Jakarta'), 'recipe_type' => 1, 'recipe_category_id' => 2],
            ['author_id' => 15, 'name' => 'Beef and Broccoli', 'image' => 'Beef_and_Brocoli.jpg', 'review_count' => 15, 'average_rating' => 4.88, 'publish_date' => Carbon::create(2019, 8, 15,  19, 32, 11, 'Asia/Jakarta'), 'recipe_type' => 1, 'recipe_category_id' => 1],
            ['author_id' => 15, 'name' => 'Chicken Satay', 'image' => 'Chicken_Satay.jpg', 'review_count' => 15, 'average_rating' => 4.88, 'publish_date' => Carbon::create(2019, 8, 15,  19, 32, 11, 'Asia/Jakarta'), 'recipe_type' => 1, 'recipe_category_id' => 1],
            ['author_id' => 15, 'name' => 'Glazed Roast Duck', 'image' => 'Glazed_Roast_Duck.jpg', 'review_count' => 15, 'average_rating' => 4.88, 'publish_date' => Carbon::create(2019, 8, 15,  19, 32, 11, 'Asia/Jakarta'), 'recipe_type' => 1, 'recipe_category_id' => 1],
        ]);
    }
}
